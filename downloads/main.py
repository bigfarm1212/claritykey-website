...
MODES = {
    'Spelling Fix Only': "Correct only standard typos and spelling of the following text. Do not change grammar, sentence structure, abbreviation, or deliberate slang. Do NOT wrap corrections in bold (**) or formatting. Return ONLY the plain text.",
    'Grammar + Spelling': "Correct spelling and grammar while preserving deliberate slang, abbreviations, and informal chat styles. Do NOT wrap any corrected words in bold (**), highlights, or asterisks. Return ONLY the plain text.",
    'Simplified Version': "Rewrite the following text in clearer, easier language. Maintain key context or names. Do NOT use markdown or bold (**). Return ONLY the plain text.",
    'Professional Rewrite': "Rewrite the following text to make it sound professional and neat. Do NOT use any bold (**), special markers, or italics to highlight changes. Return ONLY the plain text."
}
